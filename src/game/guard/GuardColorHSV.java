...
/**
 * 色指定による走行動作停止条件(HSVで判定)
 * @author 尾角 武俊
 */
public class GuardColorHSV extends Guard {
     ...
     * @param color 判定割合
     */
	public GuardColorHSV(int stopColor, int consecutivelyJudgeNum, float judgeRate) {
...
/*
	...
	public void write(ArrayList<Integer> arrJudge, int consecutivelyJudgeNum,
        ...
        try {
        	...
        	File file = new File("GuardColorHSV.csv");
